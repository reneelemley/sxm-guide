...
def specials_for(day: dt.date, band: str) -> dict:
    ...
    No area is blacked out in the autumn. It used to be - Grand Case and
    Orient Bay for fifty days, Anse Marcel for sixty-seven - on the theory
    that the French side shuts from late August. That is an exaggeration.
    Restaurants close for about a month somewhere between August and
    October, staggered, so hiding a whole area said something false.
    The low-season caveat line carries it instead.
    """
    try:
